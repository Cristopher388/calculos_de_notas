...
if(!empty($_POST)){
    ...
    if(count($errors) > 0){
        ...
        foreach ($todas_las_notas as $asignatura => $alumnos) {
            ...
            $data['informacion_clase'][$asignatura]['min']['alumno'] = array_keys(array_flip($alumnos),$data['informacion_clase'][$asignatura]['min']['nota']);
            //$data['informacion_clase'][$asignatura]['max']['alumno'] = array_key_last($alumnos);
            //$data['informacion_clase'][$asignatura]['max']['nota'] = $alumnos[$data['informacion_clase'][$asignatura]['max']['alumno']];
